...
EXEC_FILE = Assembler
C_FILES = main.c buildlabletable.c correctnesschecking.c BuildingOutput.c
H_FILES = buildlabletable.h correctnesschecking.h BuildingOutput.h ConstructsAndDefinitions
